...
using AspNetIdentityWebApp.Constants;
using AspNetIdentityWebApp.Extensions;
using AspNetIdentityWebApp.Models;
...
namespace AspNetIdentityWebApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
